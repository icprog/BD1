...
ALIGN(RT_ALIGN_SIZE)extern  MENUITEM	Menu_9_Urgent;

ALIGN(RT_ALIGN_SIZE)extern  MENUITEM	Menu_9_2_TongXin;
//ALIGN(RT_ALIGN_SIZE)extern  MENUITEM	Menu_9_3_COM;
ALIGN(RT_ALIGN_SIZE)extern	MENUITEM	Menu_9_4_IC_test;
//ALIGN(RT_ALIGN_SIZE)extern	MENUITEM	Menu_9_5_Selfcheck;
//ALIGN(RT_ALIGN_SIZE)extern	MENUITEM	Menu_9_6_Version;
ALIGN(RT_ALIGN_SIZE)extern	MENUITEM	Menu_9_7_Timed;
ALIGN(RT_ALIGN_SIZE)extern	MENUITEM    Menu_9_1_1_Location;
ALIGN(RT_ALIGN_SIZE)extern	MENUITEM    Menu_9_0_user;
ALIGN(RT_ALIGN_SIZE)extern	MENUITEM	Menu_9_0_1adress;
