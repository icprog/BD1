...
static unsigned char noselect_check[]={0x3C,0x7E,0xC3,0xC3,0xC3,0xC3,0x7E,0x3C};//空心
static unsigned char select_check[]={0x3C,0x7E,0xFF,0xFF,0xFF,0xFF,0x7E,0x3C};//实心

static unsigned char menu_pos=0;


static DECL_BMP(8,8,select_check); 
static DECL_BMP(8,8,noselect_check); 
